      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 ml-2 sm:ml-6">
          ...
          <div className="relative hidden sm:block">
            <button className="relative p-2.5 text-neutral-400 hover:text-neutral-600 hover:bg-neutral-100 rounded-xl transition-all duration-200 group">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 pl-2 sm:pl-4 border-l border-neutral-200">
            ...
            <div className="relative group">
              <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-primary-500 to-accent-500 rounded-xl flex items-center justify-center shadow-soft group-hover:shadow-medium transition-all duration-200 cursor-pointer">
                <User className="w-5 h-5 text-white" />
              </div>
              
              {/* Dropdown Menu */}
              <div className="absolute right-0 top-11 sm:top-12 w-48 bg-white rounded-xl shadow-strong border border-neutral-200/50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-2">
